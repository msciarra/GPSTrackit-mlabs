...
def upload_df_to_s3(df_to_upload, file_name, hour, today, do_cleanup):
    """
    ...
    s3_key = f'device_readings_auditing/past_auditing/{today}/{hour}/{file_name}' if do_cleanup else f'device_readings_auditing/July-September-2022-Auditing/{today}/{hour}/{file_name}'
...
def upload_success_to_s3(file_name):
    ...
    """
    bucket_name = os.environ['BUCKET_NAME']
    s3_key = f'past_auditing/{today}/{hour}/{file_name}'
